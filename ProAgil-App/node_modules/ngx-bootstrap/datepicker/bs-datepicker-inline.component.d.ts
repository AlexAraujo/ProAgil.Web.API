...
export declare class BsDatepickerInlineDirective implements OnInit, OnDestroy, OnChanges {
    ...
    setConfig(): void;
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<BsDatepickerInlineDirective, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<BsDatepickerInlineDirective, "bs-datepicker-inline", ["bsDatepickerInline"], { "isDisabled": "isDisabled"; "bsValue": "bsValue"; "bsConfig": "bsConfig"; "minDate": "minDate"; "maxDate": "maxDate"; "dateCustomClasses": "dateCustomClasses"; "dateTooltipTexts": "dateTooltipTexts"; "datesEnabled": "datesEnabled"; "datesDisabled": "datesDisabled"; }, { "bsValueChange": "bsValueChange"; }, never>;
}
